...
class LogicalStatementSpec extends ObjectBehavior {
	...
	function it_can_define_a_custom_statement()
	{
		$name = 'test';
	...
	function it_can_execute_a_custom_defined_statement()
	{
		$name = 'test';
		$input = 'name';
		$expected = 'name';
		$method = function ($input, $expected) { return true; };
		$this->defineCustomStatement($name, $method);
		$this->callCustomStatement($name, $input, $expected)->shouldReturn(true);
	}

	function it_can_execute_an_equals_statement()
	{
		$input = 'name';
		$expected = 'name';
	...
	function it_can_execute_a_not_equals_statement()
	{
		$input = 'name';
		$expected = 'notname';
	...
	function it_can_execute_an_is_not_statement()
	{
		$input = 'name';
		$expected = 'boolean';
	...
	function it_can_execute_a_not_in_statement()
	{
		$input = 4;
		$expected = [1, 2, 3];
	...
	function it_can_execute_a_between_statement()
	{
		$input = 2;
		$expected = [1, 3];
	...
	function it_can_execute_a_not_between_statement()
	{
		$input = 4;
		$expected = [1, 3];
	...
	function it_can_execute_a_null_statement()
	{
		$input = null;
		$this->null($input)->shouldReturn(true);
	}

	function it_can_execute_a_not_null_statement()
	{
		$input = 'notnull';
		$this->notNull($input)->shouldReturn(true);
	}

	function it_can_execute_a_less_than_statement()
	{
		$input = 1;
		$expected = 2;
	...
	function it_can_execute_a_not_less_than_statement()
	{
		$input = 2;
		$expected = 2;
	...
	function it_can_execute_a_greater_than_statement()
	{
		$input = 2;
		$expected = 1;
	...
	function it_can_execute_a_not_greater_than_statement()
	{
		$input = 1;
		$expected = 1;
	...
	function it_can_execute_a_less_than_or_equal_statement()
	{
		$input = 1;
		$expected = 1;
	...
	function it_can_execute_a_not_less_than_or_equal_statement()
	{
		$input = 3;
		$expected = 2;
	...
	function it_can_execute_a_greater_than_or_equal_statement()
	{
		$input = 1;
		$expected = 1;
	...
	function it_can_execute_a_not_greater_than_or_equal_statement()
	{
		$input = 1;
		$expected = 2;
