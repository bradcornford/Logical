...
class LogicalSpec extends ObjectBehavior
{
    ...
    public function it_should_allow_a_logical_statement_instance_to_be_set()
    {
    ...
    public function it_should_allow_input_to_be_set()
    {
        $input = ['key' => 'value'];
        $this->setInput($input);
    ...
    public function it_should_allow_logic_to_be_set()
    {
        $input = 'logic string';
        $this->setLogic($input);
    ...
    public function it_should_throw_an_exception_when_unable_to_decode_logic()
    {
        $input = [
            ['name' => 'tom']
        ];
    ...
    public function it_should_throw_an_exception_when_unable_to_find_a_field_value()
    {
        $input = [
            ['notname' => 'tom']
        ];
    ...
    public function it_should_throw_an_exception_when_unable_to_execute_logic_statement()
    {
        $input = [
            ['name' => 'tom']
        ];
    ...
    public function it_should_execute_the_decoded_logic_statements_on_an_array()
    {
        $input = [
            ['name' => 'tom'],
            ['name' => 'paul'],
    ...
    public function it_should_execute_the_decoded_logic_statements_on_a_class_with_visible_properties()
    {
    ...
    public function it_should_execute_the_decoded_logic_statements_on_a_class_with_getter_properties()
    {
    ...
    public function it_should_decode_a_php_string_and_evaluate()
    {
        $input1 = $this->getterPropertiesClass;
    ...
    public function it_should_decode_a_php_string_to_an_array_and_evaluate()
    {
        $input = [
            ['name' => 'tom'],
            ['name' => 'paul'],
    ...
    public function it_should_decode_a_bracketed_php_string_to_an_array_and_evaluate()
    {
        $input = [
            ['name' => 'tom'],
            ['name' => 'paul'],
